...
export class InGameEventManager extends BaseEventManager {
  ...
  private constructor(private readonly inGameManager: InGameManager) {
    ...
    this.playerHotbarSelectedSlotChange =
      InGamePlayerHotbarSelectedSlotChange.create(this);
    ...
    this.playerInventoryItemChange =
      InGamePlayerInventoryItemChange.create(this);
