...
var RoleRegistry = class _RoleRegistry {
  ...
  static create() {
    return new _RoleRegistry();
  }
  register(roles) {
    registerDefinitions({ roles });
  }
};
var FactionRegistry = class _FactionRegistry {
  constructor() {
  }
  static create() {
    return new _FactionRegistry();
  }
  register(factions) {
    registerDefinitions({ factions });
  }
};
var RoleGroupRegistry = class _RoleGroupRegistry {
  constructor() {
  }
  static create() {
    return new _RoleGroupRegistry();
  }
  register(roleGroups) {
    registerDefinitions({ roleGroups });
  }
};
var SettingRegistry = class _SettingRegistry {
  constructor() {
  }
  static create() {
    return new _SettingRegistry();
  }
  register(settings) {
    registerDefinitions({ settings });
  }
};
var PlayerRegistry = class _PlayerRegistry {
  constructor() {
  }
  static create() {
    return new _PlayerRegistry();
  }
  register(data) {
    registerPlayerDataInRegistry(data);
  }
};
var UpdateHandlerRegistry = class _UpdateHandlerRegistry {
  constructor() {
  }
  static create() {
    return new _UpdateHandlerRegistry();
  }
  register(handlers) {
    registerUpdateHandlers(handlers);
  }
};
var RoleSkillHandlerRegistry = class _RoleSkillHandlerRegistry {
  constructor() {
  }
  static create() {
    return new _RoleSkillHandlerRegistry();
  }
  register(handlers) {
    registerRoleSkillHandlersInRegistry(handlers);
  }
};
var DefinitionRegistryManager = class _DefinitionRegistryManager {
  constructor() {
    this.roles = RoleRegistry.create();
    this.factions = FactionRegistry.create();
    this.roleGroups = RoleGroupRegistry.create();
    this.settings = SettingRegistry.create();
    this.player = PlayerRegistry.create();
    this.updateHandlers = UpdateHandlerRegistry.create();
    this.roleSkillHandlers = RoleSkillHandlerRegistry.create();
  }
  static {
    this.instance = null;
  }
  static create() {
    if (!this.instance) {
      this.instance = new _DefinitionRegistryManager();
    }
...
var DefinitionManager = class _DefinitionManager {
  constructor(systemManager) {
    ...
    this.registryManager = DefinitionRegistryManager.create();
  }
  static create(systemManager) {
